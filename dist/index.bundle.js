(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["silhouette"] = factory();
	else
		root["silhouette"] = factory();
})(this, function() {
...
exports.default = function ({ compose, enhancers, middleware, state }) {
    return {
        createStore(next, namespace) {
            ...
            let e = c(...(enhancers || []), m);
            let i = r => Object.assign(next(r), (0, _redux.createStore)(r, state || {}, e));
